...
return array(
	...
	'SITE_NAME'                     => '励元科技（上海）有限公司', //网站的名称
	'SITE_DOMAIN'                   => 'liyuan.in', //网站的域名
	'SITE_MOBILE'                   => '', //移动端域名
	'SITE_LANGUAGE'                 => 'zh-cn', //网站的语言
	'SITE_THEME'                    => 'liyuan', //网站的主题风格
	'SITE_TEMPLATE'                 => 'liyuantpl', //网站的模板目录
	'SITE_TIMEZONE'                 => 8, //所在的时区常量
	'SITE_TIME_FORMAT'              => 'Y-m-d H:i', //时间显示格式，与date函数一致，默认Y-m-d H:i:s
	'SITE_TITLE'                    => '励元科技（上海）有限公司', //网站首页SEO标题
	'SITE_SEOJOIN'                  => '_', //网站SEO间隔符号
	'SITE_KEYWORDS'                 => '励元科技（上海）有限公司', //网站SEO关键字
	'SITE_DESCRIPTION'              => '励元科技（上海）有限公司', //网站SEO描述信息
	'SITE_NAVIGATOR'                => '主导航,首页幻灯,底部导航,单个图片管理,,,,,,', //网站导航信息，多个导航逗号分开
