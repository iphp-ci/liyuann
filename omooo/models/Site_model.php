...
class Site_model extends CI_Model {
    ...
    public function add_site($data) {
        ...
        CREATE TABLE IF NOT EXISTS `".$this->db->dbprefix($id.'_navigator')."` (
          ...
          `mp4` varchar(255) NOT NULL COMMENT 'mp4视频',
          `flv` varchar(255) NOT NULL COMMENT 'flv视频',
          `webm` varchar(255) NOT NULL COMMENT 'webm视频',
          `ogv` varchar(255) NOT NULL COMMENT 'ogv视频',
          `css` tinyint(10) NOT NULL COMMENT '高级样式使用',
